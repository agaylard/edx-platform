...
class TestPayAndVerifyView(UrlResetMixin, ModuleStoreTestCase, XssTestMixin):
    ...
    @ddt.data(
        ...
        ("verified", "verify_student_start_flow_ab"),
        ("professional", "verify_student_start_flow_ab")
    )
    @ddt.unpack
    def test_start_flow_not_verified(self, course_mode, payment_flow):
        ...
        if payment_flow == "verify_student_start_flow_ab":
    ...
    @ddt.data(
        ...
        ("no-id-professional", "verify_student_start_flow_ab")
    )
    @ddt.unpack
    ...
    @ddt.data(
        ...
        ("denied", "verify_student_start_flow_ab")
    )
    @ddt.unpack
    ...
    @ddt.data(
        ...
        ("verified", "submitted", "verify_student_start_flow_ab"),
        ("verified", "approved", "verify_student_start_flow_ab"),
        ("verified", "error", "verify_student_start_flow_ab"),
        ("professional", "submitted", "verify_student_start_flow_ab"),
        ("no-id-professional", None, "verify_student_start_flow_ab"),
    ...
    @ddt.data("verify_student_start_flow", "verify_student_start_flow_ab")
    ...
    @ddt.data(
        ...
        ([], "verify_student_start_flow_ab"),
        (["no-id-professional", "professional"], "verify_student_start_flow_ab"),
        (["honor", "audit"], "verify_student_start_flow_ab"),
    )
    @ddt.unpack
